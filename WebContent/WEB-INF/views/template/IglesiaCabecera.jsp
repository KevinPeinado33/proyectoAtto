...
<nav
	class="header-navbar navbar-expand-md navbar navbar-with-menu fixed-top navbar-semi-dark navbar-shadow">
		...
		<div class="navbar-header">
			<ul class="nav navbar-nav flex-row position-relative">
				...
				<li class="nav-item mr-auto"><a class="navbar-brand" href="#">
						...
						<h2 class="brand-text center-text"><i class=" fa fa-modx text-center"></i></h2>
				</a></li>
...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow"
	...
	<div class="main-menu-content">
			...
			<div class="container " style="background-color:#1087DD;color:white;margin-top:15px;margin-bottom:30px;height:55px;">
			...
			<div class="row">
				<div class="col-sm-8">
					...
					<div class="col-sm-3">
								<i class="fa fa-bullseye" style="font-size:30px;margin-top:10px;"></i>	
		...
		<ul class="navigation navigation-main" id="main-menu-navigation"
           ...
           <c:forEach var="listValue" items="${menu}">	
				...
				<li class=" nav-item"><a href="${listValue.url}"><i
					class="${listValue.icon}"></i> <span class="menu-title"
					data-i18n="">${listValue.nombre}</span> </a></li>				
