	...
	<div class="main-menu-content">
		<ul class="navigation navigation-main" id="main-menu-navigation"
			...
			<li class=" nav-item"><a href="#"><i
					class="fa fa-check-circle"></i> <span class="menu-title"
					data-i18n="">Validar pedidos</span> </a></li>

			<li class=" nav-item"><a href="#"><i class="fa fa-columns"></i>
					<span class="menu-title" data-i18n="">Registrar Faltantes</span> </a></li>
							
			<li class=" nav-item"><a href="#"><i class="fa fa-columns"></i>
					<span class="menu-title" data-i18n="">Historial</span> </a></li>		
