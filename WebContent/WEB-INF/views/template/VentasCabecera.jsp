<nav class="header-navbar navbar-expand-md navbar navbar-with-menu fixed-top navbar-semi-light bg-gradient-x-blue">
  ...
  <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
     ...
     <li class=" nav-item"><a href="solicitud" class="text-info"><i class="fa fa-plus-circle"></i><span class="menu-title" data-i18n="">Nueva Solicitud</span><span class="badge badge badge-primary badge-pill float-right mr-2"></span></a>
        </li>
       
        <li class=" nav-item"><a href="#"><i class="fa fa-child"></i><span class="menu-title" data-i18n="">Mi perfil</span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="#">Editar Perfil</a>
            </li>   
            <li><a class="menu-item" href="bandeja">Mi Bandeja</a>
            </li>          
          </ul>
        </li>
       
       
        <li class=" nav-item"><a href="#"><i class="fa fa-paperclip"></i><span class="menu-title" data-i18n="">Historial</span></a>
        </li>
                
        <li class=" nav-item"><a href="#"><i class="fa fa-arrow-circle-left"></i><span class="menu-title" data-i18n="">Salir</span></a>
        </li>       
      </ul>
    </div>
  </div>
