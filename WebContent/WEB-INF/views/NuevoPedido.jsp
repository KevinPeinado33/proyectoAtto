...
<body
			...
			<div class="content-header row">
				<div class="content-header-left col-md-6 col-12 mb-2">
					<h3 class="content-header-title mb-0">
						<i class="fa fa-plus-circle" style="margin-right: 8px;"></i>Realizar
						Pedido
					</h3>
			...
			<div class="content-body">
						...
						<div class="card">
							<div class="card-header">
								...
								<div class="card-tittle">
									...
									<h4>
										<i class="fa fa-file-text" style="margin-right: 8px;"> </i>Datos
										Generales
									</h4>
									...
									<div class="row">
										...
										<div class="col-xl-4 col-lg-6 col-md-12 mb-1">
											<fieldset class="form-group">
												<label for="in_titulo">Título:</label> <input type="text"
													id="titulo" class="form-control "
													placeholder="Ingrese titulo de pedido">
											</fieldset>
										</div>
										<div class="col-xl-8 col-lg-8 col-md-12 mb-1">
											<fieldset class="form-group">
												<label for="in-descripcion">Descripción:</label> <input
													type="text" id="descripcion" class="form-control "
													placeholder="Ingrese descripcion de pedido">
											</fieldset>
										</div>
				...
				<div class="row">
					<div class="col-12">
																...
																<div class="container">
																	...
																	<div class="row">
																		<div class="col-xl-4 col-lg-6 col-md-12">
																			<fieldset class="form-group">
																				<label for="basicSelect">Tipo Producto</label> <select
																		...
																		<div class="col-xl-8 col-lg-8 col-md-12 mb-1">
																			<fieldset class="form-group">
																				<label for="squareText">Buscar por codigo o
																					nombre de producto </label> <input type="text"
																					id="squareText" class="form-control square">
																			</fieldset>
																		</div>
						...
						<div class="container pull-right" style="margin-top: 20px;">
							<button type="button" onclick="prueba10();"
								class="btn btn-blue round btn-min-width mr-1 mb-1 float-right">
								Aceptar<i class="fa fa-chevron-right" style="margin-left: 10px;"></i>
							</button>
						</div>
                      ...
                      <input type="checkbox" id="switchery" class="switchery"/>
	...
	<script src="${urlrecursos}/app-assets/vendors/js/vendors.min.js"
		type="text/javascript"></script>
		 <script src="${urlrecursos}/app-assets/vendors/js/forms/toggle/bootstrap-checkbox.min.js"
  type="text/javascript"></script>
  <script src="${urlrecursos}/app-assets/vendors/js/forms/toggle/switchery.min.js" type="text/javascript"></script>
	...
	<script src="${urlrecursos}/app-assets/js/scripts/customizer.js"
		type="text/javascript"></script>
		<script src="${urlrecursos}/app-assets/js/scripts/forms/switch.js" type="text/javascript"></script>
		<script src="${urlrecursos}/js/nuevopedido.js"
		type="text/javascript"></script>
